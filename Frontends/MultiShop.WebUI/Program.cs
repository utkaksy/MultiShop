...
builder.Services.AddMemoryCache(); // Bu önemli, unutma
builder.Services.AddHttpClient<ClientCredentialTokenService>(); // DI için HttpClient kaydý
